...
import { ChefHat, Clock4 } from 'lucide-vue-next';
</script>
...
<template>
    ...
    >
        <div
            class="grid size-14 place-items-center rounded-full bg-ink text-cream"
        >
            <Clock4 class="size-6" />
        </div>
        <h1 class="font-display mt-5 text-3xl tracking-tight md:text-4xl">
